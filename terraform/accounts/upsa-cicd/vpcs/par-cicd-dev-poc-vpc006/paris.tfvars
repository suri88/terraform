...
# VPC CIDR
vpc_cidr_block                = "10.0.91.0/24"

vpc_name                      = "par-cicd-dev-poc-vpc006"
...
# Creates a tag with key of 'Name' and a value that you specify
security_group_name           = "par-cicd-dev-poc-local-access-vpc006-attachment-sg001"
...
s3_vpc_key   = "upsa-cicd/vpcs/par-cicd-dev-poc-vpc006/terraform.tfstate"
...
destination_cidr_block_vpc = "10.0.91.0/24"

ram_resource_name = "par-upsa-network-tgw001-cicd-poc6"
transit_gateway_arn = "arn:aws:ec2:eu-west-3:707783183724:transit-gateway/tgw-091f7791b5b901a88"
account_number = "762127463824"

tgw_attachment_name = "par-cicd-poc6-dev-attach"

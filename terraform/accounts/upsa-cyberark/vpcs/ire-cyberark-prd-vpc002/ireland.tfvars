...
# VPC CIDR
vpc_cidr_block                = "10.2.8.0/24"

vpc_name                      = "ire-cyberark-prd-vpc002"
...
# Creates a tag with key of 'Name' and a value that you specify
security_group_name           = "ire-cyberark-prd-dr-vpc002-attachment-sg001"
...
s3_vpc_key   = "upsa-cyberark/vpcs/ire-cyberark-prd-vpc002/terraform.tfstate"
...
destination_cidr_block_vpc = "10.2.8.0/24"

ram_resource_name = "ire-upsa-network-tgw001-cyberark-002"
transit_gateway_arn = "arn:aws:ec2:eu-west-1:707783183724:transit-gateway/tgw-013453c3059f98696"
account_number = "734839700165"

tgw_attachment_name = "ire-cyberark-prd-attach002"

...
vpc_name                      = "par-easylog-dev-vpc001"

vpc_role                      = "EasyLog-Dev"
...
app_network_acl_role          = "EasyLog-Dev Applications Ingress Access Control List"
...
web_network_acl_role          = "EasyLog-Dev Web Ingress Access Control List"
...
dbs_network_acl_role          = "EasyLog-Dev Database Ingress Access Control List"
...
# Creates a tag with key of 'Name' and a value that you specify
security_group_name           = "par-easylog-dev-local-access-vpc001-sg001"

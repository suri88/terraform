...
# VPC CIDR
vpc_cidr_block                = "10.0.14.0/24"

vpc_name                      = "par-easylog-prd-vpc001"

vpc_role                      = "EasyLog-Prd"
...
app_network_acl_role          = "EasyLog-Prd Applications Ingress Access Control List"
...
web_network_acl_role          = "EasyLog-Prd Web Ingress Access Control List"
...
dbs_network_acl_role          = "EasyLog-Prd Database Ingress Access Control List"
...
# Creates a tag with key of 'Name' and a value that you specify
security_group_name           = "par-easylog-prd-local-access-vpc001-sg001"

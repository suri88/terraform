...
# VPC CIDR
vpc_cidr_block                = "10.0.13.0/24"

vpc_name                      = "par-easylog-uat-vpc001"

vpc_role                      = "EasyLog-Uat"
...
app_network_acl_role          = "EasyLog-UAT Applications Ingress Access Control List"
...
web_network_acl_role          = "EasyLog-UAT Web Ingress Access Control List"
...
dbs_network_acl_role          = "EasyLog-UAT Database Ingress Access Control List"
...
# Creates a tag with key of 'Name' and a value that you specify
security_group_name           = "par-easylog-uat-local-access-vpc001-sg001"

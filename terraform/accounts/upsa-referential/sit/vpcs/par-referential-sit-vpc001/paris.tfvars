...
vpc_name                      = "par-referential-sit-vpc001"

vpc_role                      = "Referential Sit"
...
# Creates a tag with key of 'Name' and a value that you specify
security_group_name           = "par-referential-sit-local-access-vpc001-attachment-sg001"
...
tgw_attachment_name = "par-referential-sit-vpc001-attach"
transit_gateway_route_table_id = "tgw-rtb-07989faa22fc2bb3e"

s3_bucket = "upsa.eu.west.3.referential-sit.terraform-remote-state"
s3_vpc_key   = "upsa-referential/sit/vpcs/par-referential-sit-vpc001/terraform.tfstate"
...
destination_cidr_block_vpc = "10.0.16.0/24"

ram_resource_name = "par-upsa-network-tgw001-referential-sit"
transit_gateway_arn = "arn:aws:ec2:eu-west-3:707783183724:transit-gateway/tgw-091f7791b5b901a88"
account_number = "253634665593"

...
# VPC CIDR
vpc_cidr_block                = "10.2.10.0/24"

vpc_name                      = "ire-sss-prd-vpc001"

vpc_role                      = "SSS Prd DR VPC attachment"
...
# Creates a tag with key of 'Name' and a value that you specify
security_group_name           = "ire-sss-prd-dr-vpc001-attachment-sg001"
...
s3_bucket = "upsa.eu.west.1.sss.terraform-remote-state"
s3_vpc_key   = "upsa-sharedservices/vpcs/ire-sss-prd-vpc001/terraform.tfstate"
...
destination_cidr_block_vpc = "10.2.10.0/24"

ram_resource_name = "ire-upsa-network-tgw001-sss-001"
transit_gateway_arn = "arn:aws:ec2:eu-west-1:707783183724:transit-gateway/tgw-013453c3059f98696"
account_number = "417417470155"

tgw_attachment_name = "ire-sss-prd-attach"

...
# VPC CIDR
vpc_cidr_block                = "10.0.19.0/24"

vpc_name                      = "par-transparence-dev-vpc001"

vpc_role                      = "Transparence dev"
...
# Creates a tag with key of 'Name' and a value that you specify
security_group_name           = "par-transparence-dev-local-access-vpc001-attachment-sg001"
...
tgw_attachment_name = "par-transparence-dev-vpc001-attach"
transit_gateway_route_table_id = "tgw-rtb-07989faa22fc2bb3e"

s3_bucket = "upsa.eu.west.3.transparence-dev.terraform-remote-state"
s3_vpc_key   = "upsa-transparence/dev/vpcs/par-transparence-dev-vpc001/terraform.tfstate"
...
destination_cidr_block_vpc = "10.0.19.0/24"

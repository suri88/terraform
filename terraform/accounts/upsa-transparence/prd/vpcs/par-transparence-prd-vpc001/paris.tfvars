...
# VPC CIDR
vpc_cidr_block                = "10.0.22.0/24"

vpc_name                      = "par-transparence-prd-vpc001"

vpc_role                      = "Transparence Prod"
...
app_network_acl_role      = "Transparence Prod Applications Ingress Access Control List"
...
web_network_acl_role      = "Transparence Prod Web Ingress Access Control List"
...
dbs_network_acl_role      = "Transparence Prod Database Ingress Access Control List"
...
# Creates a tag with key of 'Name' and a value that you specify
security_group_name           = "par-transparence-prd-local-access-vpc001-attachment-sg001"
...
tgw_attachment_name = "par-transparence-prd-vpc001-attach"
transit_gateway_route_table_id = "tgw-rtb-07989faa22fc2bb3e"

s3_bucket = "upsa.eu.west.3.transparence-prd.terraform-remote-state"
s3_vpc_key   = "upsa-transparence/prd/vpcs/par-transparence-prd-vpc001/terraform.tfstate"
...
destination_cidr_block_vpc = "10.0.22.0/24"

ram_resource_name = "par-upsa-network-tgw001-transparence-prd"
transit_gateway_arn = "arn:aws:ec2:eu-west-3:707783183724:transit-gateway/tgw-091f7791b5b901a88"
account_number = "383767217836"


#########################################################################################
# Global tags to be applied to all AWS resources created in transparence dev
#########################################################################################
upsa_account_tags = {

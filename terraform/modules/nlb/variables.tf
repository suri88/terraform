...
variable "target_ids" {
   description = "A list of string containing key/value pairs that define the target ids "
   type        = list(string)
   default     = []
}

variable "target_port" {
  description = "A ports associate with aws_lb_target_group_attachment"
  type = number
}
...
variable aws_lb_name {
   description = "Name to be used on nlb"
   type = string
   default = ""
}

variable aws_lb_role {
   description = "Role to be used on nlb"
   type = string
   default = ""
}
